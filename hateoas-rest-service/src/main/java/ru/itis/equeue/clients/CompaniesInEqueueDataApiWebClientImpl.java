...
import ru.itis.equeue.entries.MyApiCompaniesRecord;

import java.util.Arrays;

@Component
public class CompaniesInEqueueDataApiWebClientImpl implements CompaniesClient {

    // реактивная штука для отправки запросов на другие сервисы
    private WebClient client;

    public CompaniesInEqueueDataApiWebClientImpl(@Value("${myapidata.url}") String url) {
